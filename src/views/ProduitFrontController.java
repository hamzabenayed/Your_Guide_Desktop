   ...
   @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tableP.getItems().setAll(ll);
            ...
            nomP.setOnEditCommit(new EventHandler<TableColumn.CellEditEvent<Produit, String>>() {
            ...
            public void handle(TableColumn.CellEditEvent<Produit, String> event) {
             ...
             descP.setOnEditCommit(new EventHandler<TableColumn.CellEditEvent<Produit, String>>() {
            ...
            public void handle(TableColumn.CellEditEvent<Produit, String> event) {
              ...
              PrixP.setOnEditCommit(new EventHandler<TableColumn.CellEditEvent<Produit, Integer>>() {
